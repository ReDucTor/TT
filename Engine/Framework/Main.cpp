...
int WINAPI wWinMain( HINSTANCE hInst,HINSTANCE,LPWSTR pArgs,INT )
{
	...
	const unsigned int width = GetPrivateProfileInt(L"Graphics", L"ScreenWidth", 1366, L"settings.ini");
	const unsigned int height = GetPrivateProfileInt(L"Graphics", L"ScreenHeight", 768, L"settings.ini");
	try
	{
