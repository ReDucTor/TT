...
class HWNDKey
{
	friend Graphics::Graphics( HWNDKey& ,unsigned int width,unsigned int height );
public:
...
public:
	MainWindow( HINSTANCE hInst,wchar_t* pArgs ,unsigned int width,unsigned int height);
