...
public:
	...
	RectF MeasureString(const std::wstring & string, int length, const Font& font, const RectF inrect);
	void DrawString( const std::wstring& string,const Vec2& pt,const Font& font,Color c );
	void DrawClipString( const std::wstring& string,const RectF& pt,const Font& font,Color c);
